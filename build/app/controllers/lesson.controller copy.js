...
exports.LessonController = {
    ...
    getLessonById: function (id) {
        var r = lesson_model_1.LessonModel.findById(id).populate('lastNameTeacher');
        console.log(r.lessonName);
        return r;
    },
    ...
    updateLessonById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log(id);
            return [2 /*return*/, lesson_model_1.LessonModel.findByIdAndUpdate(id, { lessonName: "matem", lessonTime: "10:10" })
                    .then(function (data) {
                    return data;
                })
                    .catch(function (error) {
